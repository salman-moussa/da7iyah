                ...
                mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraSmall),
                    ...
                    Padding(padding: const EdgeInsets.symmetric(vertical: 5.0),
                      ...
                      productModel.discount!= null && productModel.unitPrice! > 0 && productModel.discount! > 0 ?
                  ...
                  productModel.unitPrice! > 0 ?
                    Text(PriceConverter.convertPrice(context,
                      ...
                      style: titilliumSemiBold.copyWith(color: ColorResources.getPrimary(context)))  : const SizedBox.shrink(),
                  ],
                ),
              ),
            ),

        ...
        child: AppBar(
          ...
          backgroundColor: Theme.of(context).cardColor,
            ...
            Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeDefault),
              child: SizedBox(child: Provider.of<ThemeController>(context, listen: false).darkTheme ?Image.asset(Images.logoWithNameImageWhite):Image.asset(Images.logoWithNameImage))): const SizedBox())

      ...
      children: [
        Consumer<BannerController>(
          builder: (context, bannerProvider, child) {
            if (bannerProvider.mainBannerList.isEmpty) {
              bannerProvider.getBannerList(true); // Fetch banner list if empty
            }
              ...
              children: [
                bannerProvider.mainBannerList.isNotEmpty
                  ...
                  child: Column(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: CustomImageWidget(
                                    image:
                                    '${Provider.of<SplashController>(context, listen: false).baseUrls?.bannerImageUrl}/${bannerProvider.mainBannerList[index].photo}',
                                  ),
                                ),
                              ),
                            );
                    ...
                    : const BannerShimmer(),
                if (bannerProvider.mainBannerList.isNotEmpty)
                  Positioned(
                    bottom: 0,
                    left: 0,
                    right: 0,

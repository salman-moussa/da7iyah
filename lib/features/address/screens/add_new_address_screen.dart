...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  final TextEditingController _zipCodeController = TextEditingController(text: '961');
  ...
  void initState() {
    ...
    // Set the country code to the first item in the dropdown if it exists
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (Provider.of<AddressController>(context, listen: false).restrictedCountryList.isNotEmpty) {
        setState(() {
          _countryCodeController.text = Provider.of<AddressController>(context, listen: false).restrictedCountryList.first;
        });
      }
    });
  }
                    ...
                    return Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        CustomTextFieldWidget(
                          ...
                          required: false,
                          prefixIcon: Images.city,
                          controller: _zipCodeController, // Ensure this is either null or properly initialized
                        )
                            :
                          ...
                          child: !addressController.isLoading ? CustomButton(
                            ...
                            onTap: locationController.loading ? null : () {
                              ...
                              AddressModel addressModel = AddressModel(
                                  ...
                                  zip: _zipCodeController.text.isEmpty ? null : _zipCodeController.text, // Set ZIP code to null if empty

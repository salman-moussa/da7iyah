          ...
          Card(
            ...
            child: Column(
              children: [
                    ...
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: CustomImageWidget(
                          image: '${Provider.of<SplashController>(context, listen: false).baseUrls?.productThumbnailUrl}/${widget.orderDetailsModel.productDetails?.thumbnail ?? ''}',
                          width: 80,
                          height: 80,
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const Spacer(),
                              SizedBox(
                                height: (widget.orderDetailsModel.productDetails != null && widget.orderDetailsModel.productDetails?.productType == 'digital' && widget.paymentStatus == 'paid')
                              ...
                              (widget.orderDetailsModel.productDetails?.productType == 'digital' && widget.paymentStatus == 'paid')
                                ...
                                builder: (context, orderProvider, _) {
                                  return InkWell(
                                    onTap: () async {
                                      if (widget.orderDetailsModel.productDetails?.digitalProductType == 'ready_after_sell' && widget.orderDetailsModel.digitalFileAfterSell == null) {
                                              ...
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (_) => VerificationScreen(
                                                    ...
                                                    '',
                                                    '',
                                                    orderId: widget.orderDetailsModel.id,
                                                    fromDigitalProduct: true,
                                                  ),
                                                ),
                                              );
                                            }
                                        ...
                                        child: Center(
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(width: Dimensions.iconSizeDefault, child: Image.asset(Images.fileDownload, color: Theme.of(context).cardColor)),
                                            ],
                                          ),
                                        ),
                                      ),
                    ...
                    child: Row(
                      children: [
                        ...
                        Consumer<RefundController>(builder: (context, refund, _) {
                          return (orderController.orderTypeIndex == 1 && widget.orderDetailsModel.refundReq == 0 && widget.orderType != "POS")
                              ? InkWell(
                            onTap: () {
                              Provider.of<ReviewController>(context, listen: false).removeData();
                        ...
                        Consumer<RefundController>(builder: (context, refundController, _) {
                          return (orderController.orderTypeIndex == 1 && widget.orderDetailsModel.refundReq != 0 && widget.orderType != "POS")
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) => RefundDetailsWidget(
                                        ...
                                        orderDetailsId: widget.orderDetailsModel.id,
                                        orderDetailsModel: widget.orderDetailsModel,
                                        createdAt: widget.orderDetailsModel.createdAt,
                                      ),
                                    ),
                                  );
                                }
                            ...
                            child: refundController.isLoading
                              ...
                              child: Text(
                                getTranslated('refund_status_btn', context) ?? '',
                                style: titilliumRegular.copyWith(
                                  fontSize: Dimensions.fontSizeDefault,
                                  color: Theme.of(context).highlightColor,
                                ),
                ...
                widget.orderDetailsModel.refundReq == 0 && widget.orderType != "POS" ? const SizedBox(height: Dimensions.paddingSizeLarge) : const SizedBox(),
              ],
            ),
          ),
          Positioned(

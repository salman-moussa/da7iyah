...
class AllSellerCard extends StatefulWidget {
  final Seller? sellerModel;
  final bool isHomePage;
  final int index;
  final int length;
  const AllSellerCard({super.key, this.sellerModel, this.isHomePage = false, required this.index, required this.length});

  @override
  State<AllSellerCard> createState() => _SellerCardState();
}

class _SellerCardState extends State<AllSellerCard> {

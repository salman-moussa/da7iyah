      ...
      body: SafeArea(child: RefreshIndicator(
          ...
          child: CustomScrollView(controller: _scrollController, slivers: [
            SliverAppBar(
              ...
              title:Provider.of<ThemeController>(context, listen: false).darkTheme ? Image.asset(Images.logoWithNameImageWhite, height: 35):Image.asset(Images.logoWithNameImage, height: 35), actions: const [
              CartHomePageWidget()]),

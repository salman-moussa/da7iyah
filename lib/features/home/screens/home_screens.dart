...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadData(bool reload) async {
     ...
     await Provider.of<ShopController>(Get.context!, listen: false).getTopSellerList(reload, 1, type: "top");
      await Provider.of<ShopController>(Get.context!, listen: false).getAllSellerList(reload, 1, type: "a");
    ...
    return Scaffold(resizeToAvoidBottomInset: false,
      body: SafeArea(child: RefreshIndicator(
          onRefresh: () async {
            ...
            await Provider.of<ShopController>(Get.context!, listen: false).getAllSellerList(true, 1, type: "a");
          ...
          child: CustomScrollView(controller: _scrollController, slivers: [
              SliverAppBar(
                ...
                backgroundColor: Theme.of(context).highlightColor,
                  title: Provider.of<ThemeController>(context, listen: false).darkTheme ? Image.asset(Images.logoWithNameImageWhite, height: 35) : Image.asset(Images.logoWithNameImage, height: 35),
                  ...
                  Consumer<ShopController>(
                    builder: (context, topSellerProvider, child) {
                      ...
                      TitleRowWidget(title: getTranslated('top_seller', context),
                          onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (_) =>
                          const AllTopSellerScreen( title: 'top_stores',isBacButtonExist: true,)))):
                      const SizedBox();}),

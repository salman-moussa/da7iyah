            ...
            builder: (context, splashProvider, _) {
              return ListView(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault), children: [
                Center(child: Padding(padding: const EdgeInsets.all(50),
                    child: Provider.of<ThemeController>(context, listen: false).darkTheme ?Image.asset(Images.logoWithNameImageWhite, height: 150, width: 150):Image.asset(Images.logoWithNameImage, height: 150, width: 150)
